...
object NewLinearRegressionTrainScala {
  def main(args: Array[String]): Unit ={
    ...
    val vectorSlicer2 = new VectorAssembler().setInputCols(Array[String]("BENEFICIARY_ACCOUNT_ID", "prediction")).setOutputCol("feats")

    val export_pipeline = SparkUtil.createPipelineModel(uid = "pipeline",Array(vectorSlicer, lrModel))
